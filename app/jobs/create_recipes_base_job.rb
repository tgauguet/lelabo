	...
	def perform(user)
		begin
			if !user.ingredients.blank?
				...
				image5 = File.new(Rails.root.join("public", "assets", "enrobage.jpg"))
				image6 = File.new(Rails.root.join("public", "assets", "macaron.jpg"))
				image7 = File.new(Rails.root.join("public", "assets", "tablettemarbre.png"))
				image8 = File.new(Rails.root.join("public", "assets", "gommearabique.jpg"))
				image9 = File.new(Rails.root.join("public", "assets", "chocolat-blanc.jpg"))
				image10 = File.new(Rails.root.join("public", "assets", "noisette.jpg"))
				image11 = File.new(Rails.root.join("public", "assets", "amandes.jpg"))
