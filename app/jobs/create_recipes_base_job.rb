	...
	def perform(user)
		begin
			if !user.ingredients.blank?
				image1 = File.new(Rails.root.join("assets", "hot-chocolate.jpg"))
				image2 = File.new(Rails.root.join("assets", "gianduja.jpg"))
				image3 = File.new(Rails.root.join("assets", "truffe.jpg"))
				image4 = File.new(Rails.root.join("assets", "amandecara.jpg"))
				image5 = File.new(Rails.root.join("assets", "enrobage.jpg"))
				image6 = File.new(Rails.root.join("assets", "macaron.jpg"))
				image7 = File.new(Rails.root.join("assets", "tablettemarbre.png"))
				image8 = File.new(Rails.root.join("assets", "gommearabique.jpg"))
				image9 = File.new(Rails.root.join("assets", "chocolat-blanc.jpg"))
				image10 = File.new(Rails.root.join("assets", "noisette.jpg"))
				image11 = File.new(Rails.root.join("assets", "amandes.jpg"))
	      ...
	      user.recipes.all.each do |recipe|
	        ...
	        4.times { recipe.totals.create(value:  (recipe.totals.count + 1)) }
				...
				user.assemblies.create!([
					{ title:"Noisettes enrobées", category: "Confiserie", owner:"Le Labo",image: image10, "recipe_items_attributes"=>{"0"=>{recipe_id: fruitscaramelise.id, "_destroy"=>"false"}, "1"=>{recipe_id: enrobagefruits.id, "_destroy"=>"false"}, "2"=>{recipe_id: glacagegomme.id, "_destroy"=>"false"}}},
					{ title:"Amandes enrobées", category: "Confiserie", owner:"Le Labo",image: image11, "recipe_items_attributes"=>{"0"=>{recipe_id: fruitscaramelise.id, "_destroy"=>"false"}, "1"=>{recipe_id: enrobagefruits.id, "_destroy"=>"false"}, "2"=>{recipe_id: glacagegomme.id, "_destroy"=>"false"}}}
					])
			end
		rescue
