	...
	def perform(user)
		begin
	      ...
	      bdc = user.ingredients.find_by_name("Beurre de cacao")
				...
				extra = user.ingredients.find_by_name("Chocolat Extra Bitter Valrhona 61%")
