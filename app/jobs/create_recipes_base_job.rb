	      ...
	      user.recipes.all.each do |recipe|
	        ...
	        4.times { recipe.totals.create(value:  (recipe.totals.count + 1)) }
				...
				user.assemblies.create!([
					{ title:"Noisettes enrobées", category: "Confiserie", owner:"Le Labo",image: File.open("#{Rails.root}/app/assets/images/base-recipe-img/noisette.jpg"), "recipe_items_attributes"=>{"0"=>{recipe_id: fruitscaramelise.id, "_destroy"=>"false"}, "1"=>{recipe_id: enrobagefruits.id, "_destroy"=>"false"}, "2"=>{recipe_id: glacagegomme.id, "_destroy"=>"false"}}},
					{ title:"Amandes enrobées", category: "Confiserie", owner:"Le Labo",image: File.open("#{Rails.root}/app/assets/images/base-recipe-img/amandes.jpg"), "recipe_items_attributes"=>{"0"=>{recipe_id: fruitscaramelise.id, "_destroy"=>"false"}, "1"=>{recipe_id: enrobagefruits.id, "_destroy"=>"false"}, "2"=>{recipe_id: glacagegomme.id, "_destroy"=>"false"}}}
					])
			end
		rescue
