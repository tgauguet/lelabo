...
class AssembliesController < ApplicationController
	...
	def assembly_params
		params.require(:assembly).permit(:recipe_id, :image, :stock, :to_produce, :sold, :category, :notes, :recipes, :description, :title, :owner, :loved, :stared, images_attributes: [:picture, :assembly_id , :description, :_destroy, :id], totals_attributes: [:value, :total,  :id, :_destroy], recipe_items_attributes: [:id, :_destroy, :recipe_id, :total])
	end
end
