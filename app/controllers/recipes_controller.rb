class RecipesController < ApplicationController
  ...
  private
    ...
    def recipe_params
      params.fetch(:recipe, {}).permit(:name, :total, :portion, :portion_weight, :portion_price, :owner, :stared, :loved, :image, :baking, :ingredient_id, :description, :process, :note, :equipment, :category, :user_id, quantities_attributes: [:id, :weight, :ingredient_id, :_destroy], totals_attributes: [:value, :total,  :id, :_destroy], images_attributes:[:id, :_destroy, :picture, :recipe_id, :description])
    end
end
